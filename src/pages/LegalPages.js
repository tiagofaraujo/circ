  ...
  return (
    <main className="page legal-page">
      ...
      <LegalSection title={en ? '4. Technology and service providers' : '4. Tecnologia e prestadores de serviços'}>
        <p>
          {en
            ? 'The website is delivered through Cloudflare infrastructure. The My CIRC authentication architecture is based on Google Firebase Authentication. The contact form is transmitted through EmailJS to the organisation email account. These providers process data only to the extent required to provide their respective technical services and according to their own contractual and privacy frameworks.'
            : 'O website é disponibilizado através de infraestrutura Cloudflare. A arquitetura de autenticação da Área CIRC baseia-se no Google Firebase Authentication. O formulário de contacto é transmitido através do EmailJS para a caixa de correio da organização. Estes prestadores tratam dados na medida necessária à prestação dos respetivos serviços técnicos e de acordo com os seus enquadramentos contratuais e de privacidade.'}
        </p>
        <p>
